...
for p_res in p_res_range:
    ...
    network.name = 'Network'+str(net_name_ind)
    net_name_ind = net_name_ind + 1
    ## For levels of average demand per node: 
    for demav in dem_av_range:
        CaseStudy = synergies.CaseStudy(network, demav, peak_to_off, route_costs,
        ...
        # problem infeasible.
        new_exp = synergies.Experiment(CaseStudy, 'bus_only')
        ...
        new_exp = synergies.Experiment(CaseStudy, 'truck_only')
...
## Plot VMT as a function of average demand.
